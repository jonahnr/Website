...
<a class="nav-menu-child nav-menu-scorecard nav-menu-path-00" href="${prefix}dashboard-trust-scorecard.html"><span>Diagnostic Scorecard</span><em>Optional</em></a>
...
<link href="${prefix}home.css?v=143" rel="stylesheet"/>
...
<strong>Share</strong>
<button type="button" data-copy-share="${url}">Share Link</button>
...
${footer(prefix)}
<script src="${prefix}home.js?v=143"></script>
</body>
</html>
`;
}
